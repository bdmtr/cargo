...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <nav class="my-2 my-md-0 mr-md-3">
        <a class="p-2 text-dark" href="controller?action=calculatorpage">Calculator</a>
        <a class="p-2 text-dark" href="controller?action=SearchCityGuest">Show all Guest Cargo</a>
        <a href="controller?action=UK">UK</a>
        <a href="controller?action=EN">EN</a>
    </nav>
    <a class="btn btn-outline-primary" href="controller?action=login">login</a>
</div>
